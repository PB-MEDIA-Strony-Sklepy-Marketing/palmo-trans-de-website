...
if ( ! function_exists( 'truck_tribe_events_get_css' ) ) {
	add_filter( 'truck_filter_get_css', 'truck_tribe_events_get_css', 10, 2 );
	function truck_tribe_events_get_css( $css, $args ) {
