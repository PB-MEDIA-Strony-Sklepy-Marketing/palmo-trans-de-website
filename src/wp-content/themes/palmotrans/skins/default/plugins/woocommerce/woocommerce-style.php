...
if ( ! function_exists( 'truck_woocommerce_get_css' ) ) {
	add_filter( 'truck_filter_get_css', 'truck_woocommerce_get_css', 10, 2 );
	function truck_woocommerce_get_css( $css, $args ) {
...
$fdir = truck_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
