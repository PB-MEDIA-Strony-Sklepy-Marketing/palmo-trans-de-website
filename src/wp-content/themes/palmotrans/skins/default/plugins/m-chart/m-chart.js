...
( function() {
	...
	var chartOptions = {
	    ...
	    legend: {
	    	itemDistance: truck_m_chart_legend_spacer(),
	    	itemMarginBottom: 7,
			itemMarginTop: 0,
	    	itemStyle: {
	            fontSize: '16px',
	...
	function truck_m_chart_render(chart) {
		...
		chart.find('.highcharts-legend .highcharts-point').each(function() {
			...
			var rgb = truck_m_chart_hexToRgb(fill);
	...
	function truck_m_chart_hexToRgb(hex) {
	    var c;
	...
	function truck_m_chart_legend_spacer() {
